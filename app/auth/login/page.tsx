      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-black-100 border border-blue-500/30 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Email Field */}
            <div>
              <label htmlFor="email" className="block text-white-50 mb-2 text-sm font-medium">
                Email Address
              </label>
              <input
                id="email"
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="password" className="block text-white-50 mb-2 text-sm font-medium">
                Password
              </label>
              <input
                id="password"
